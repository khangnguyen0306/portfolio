...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/nguyen-trong-khang-57b7292ba/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Nguyễn Trọng Khang",
    icon: Facebook,
    url: "https://www.facebook.com/nguyenkhang0306",
    color: "#2176ff",
    gradient: "from-[#2176ff] via-[#1a5ecc] to-[#134699]"
  },
  {
    name: "Email",
    displayName: "Email",
    subText: "Nguyễn Trọng Khang",
    icon: Mail,
    url: "mailto:khangnguyen68318@gmail.com",
    color: "#42ae73",
    gradient: "from-[#2e7b51] to-[#2e7b51]"
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@Nguyễn Trọng Khang",
    icon: Github,
    url: "https://github.com/khangnguyen0306",
    color: "#ffffff",
