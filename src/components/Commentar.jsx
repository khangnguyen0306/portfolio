...
const staticPinnedComment = {
    id: 1,
    user_name: 'Admin',
    content: 'Welcome to the portfolio! Feel free to leave your thoughts below.',
    profile_image: '',
    is_pinned: true,
...
const staticComments = [
    {
        id: 2,
        user_name: 'Jane Doe',
        content: 'Great portfolio! Very inspiring.',
        profile_image: '',
        is_pinned: false,
    ...
    },
    {
        ...
        content: 'I love the design and the projects you showcased.',
        profile_image: '',
        is_pinned: false,
...
const CommentForm = memo(({ onSubmit, isSubmitting, error }) => {
    ...
    }, [newComment, userName, imageFile, imagePreview, onSubmit]);
...
const Komentar = () => {
    ...
    const [pinnedComment] = useState(staticPinnedComment);
